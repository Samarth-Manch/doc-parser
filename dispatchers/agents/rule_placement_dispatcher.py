...
- variableName: generated by converting field_name to lowercase, removing all spaces and underscores, wrapped in single underscores (e.g., "Field Name" -> "_fieldname_"). NO internal underscores allowed.
"""
