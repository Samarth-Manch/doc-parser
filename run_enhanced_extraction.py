#!/usr/bin/env python3
"""
Run enhanced rule extraction for Vendor Creation Sample BUD.
"""
...
def main():
    ...
    output_schema = output_dir / "populated_schema_v2.json"
    output_report = output_dir / "extraction_report_v2.json"
