...
python3 dispatchers/agents/session_based_dispatcher.py --clear-child-output "${OUT_DIR}/clear_child_fields/all_panels_clear_child.json" --bud "documents/Vendor Creation Sample BUD.docx" --output "${OUT_DIR}/session_based/all_panels_session_based.json"
